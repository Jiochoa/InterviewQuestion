...
- [ ] Fine tune controllers
	- [ ] make them more intuitive and adjust to mobile
	- [ ] take off double jump and make hold jump more appealing
- [ ] Fix hold to jump + platform movement
...
##### What I worked on in this iteration 1
Divided the stage into 3 sections where the player picked up enough batteries to open the 3 doors. This is mainly to increase the time. The target goal is 5 minutes for each level.

##### What's Missing 1
- [ ] take off the middle door and make the last door harder to reach

#### Level 2: City (some street)
The player will come out of the parking lot into a crowded street which is where the level will start. The player will have to avoid some `puddles of acid` as well as some `cleaning drones` working the mess. The player will reach an intersection but nothing will happen there (for now) Then the next street will be an abandoned building with a lot of `toxic waste` and drones cleaning the mess. which you will use to avoid touching the ground.  And lastly, crossing the street will be a construction site which will have some dangers to avoid and will end with the player `climbing up a chain` to reach the second floor which is where you'll find an open window to climb and end the level.
...
##### What I worked on in this iteration 2
Added platforms on the buildings to make use of some jumping.

##### What's Missing 2
- [ ] A building entrance with a people's elevator which is where the cat will start 
- [ ] Moving cars (thinking of taking them off)
- [ ] add more detail to the constructions site
...
##### What I worked on in this iteration 3
Made the Roombas faster and less predictable. 


##### What's Missing 3
- [ ] sprites/structure of family in living room
- [ ] moving chandelier (undecided)
- [ ] make a "slow down section"

#### Level 4: Building (Emergency stairs)
As the player exits the window out into a emergency stairs. The player then will have to climb up to the roof. He will need to avoid `window cleaners` as well as `flying security cameras`. The level will end at the top of the building.
...
##### What I worked on in this iteration 4
made 7 floors all with something different.

##### What's Missing 4
- [x] floor size and proportions
- [x] make the ending reachable
- [ ] decide on different traps on each floor
- [ ] polish floors
...
##### What I worked on in this iteration 5
##### What's Missing 5
- [x] Make the end reachable
- [ ] Fix speed and size of floating platforms
...
- [x] sprites of night sky (Need to be really good and shiny)
- [ ] make it like Alto
	- [ ] change skating speed
	- [ ] make it all one and change the wave form
